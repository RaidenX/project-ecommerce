...
class ManageProduct extends Component {
  ...
  onAddProductClick = () => {
    ...
    axios
      .post("http://localhost:1806/products", {
        name: pName,
        desc: pDesc,
        price: pPrice,
        src: pSrc
  ...
  onProdDel = id => {
    ...
    axios
      .delete(`http://localhost:1806/products/${delId}`)
  ...
  onSaveItem = id => {
    ...
    axios
      .put(`http://localhost:1806/products/${id}`, {
        name: eName,
        desc: eDesc,
        price: ePrice,
        src: eSrc
  ...
  getProduct = () => {
    axios.get("http://localhost:1806/products").then(res => {
